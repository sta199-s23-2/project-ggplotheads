...
We hypothesize that men, overage, will have more success than American females in Winter Olympics. 
...
```
This p-value is 0.676 which means that given the null hypothesis is true (the mean medal rank for men and women in the United States is equal), there is a 0.676 chance that the alternative hypothesis is true. Therefore, given an $\alpha$ = 0.05, this null hypothesis cannot be rejected.  
