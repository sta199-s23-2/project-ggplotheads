...
Process: 1. Group the Winter Olympic events into similar categories (skating, skiing/snowboarding, team events, track events) 2. Filter out team events because there is no age variable 3. Created faceted bar plot with grouped events.
  ...
  Possible visual idea: color by medal and put color as medal color: gold for 
  gold, etc.?
...
Process: 1. Filter for Scandanavian countries and for events that include skiing 2. Probability for each medal type 3. Visualization comparing probabilities
